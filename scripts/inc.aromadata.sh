...
form(
    ...
    "inclorexcl",     "Выберите ваш вариант",        "",                    "group",
      "1",     "Включить",   "Выберите приложения для установки.",             "select.selected",
      "0",     "Исключить",   "Выберите приложения для исключения.",       "select",
...
form(
    ...
    "remove",     "Приложения для удаления",        "",                                         "group",
      ...
      "Browser",     "<b>Stock/AOSP Browser</b>",       "(автоматически удаляется если Google Chrome установлен)",                      "check",
      ...
      "Gallery",     "<b>Stock/AOSP Gallery</b>",       "(автоматически удаляется если Google Photos установлен)",                      "check",
      ...
      "Launcher",     "<b>Stock/AOSP Launcher(s)</b>",       "(автоматически удаляется если Google Launcher установлен)",                      "check",
      "LiveWallpapers",     "<b>Live Wallpapers</b>",       "",                      "check",
      "LockClock",     "<b>Lock Clock</b>",       "(присутствует в некоторых прошивках)",                      "check",
      "MMS",     "<b>Stock/AOSP MMS</b>",       "(автоматически удаляется если Google Hangouts и Messenger установлен)",                      "check",
